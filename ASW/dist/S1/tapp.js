"use strict";
// import { IAlumno, IAsignatura, Nota, Notas, Asignaturas, Alumnos } from "./P1";
// import { buscarAlumno, buscarAsignatura, buscarNota } from "./P1";
// import { buscarNotaPromise, buscarAlumnoPromise, buscarAsignaturaPromise } from "./P1";
// import { buscarAlumnoAsyncAwait, buscarNotaAsyncAwait, buscarAsignaturaAsyncAwait } from "./P1";
...
// Notas.forEach(nota => {
//     console.log(`ID: ${nota.ID}, Descripcion: ${nota.Descripción}, Valor: ${nota.Valor}`); 
// });
...
//        let nota = Notas[i];
//        console.log(`ID: ${nota.ID}, ID Asignatura: ${nota.ID_Asignatura}, ID Alumno: ${nota.ID_Alumno}, Fecha: ${nota.Fecha}, Valor: ${nota.Valor}`);
//    }
//}
